...
#ifdef VENDOR_EDIT
#Meilin.Zhou@BSP.Fingerprint.Secure, 2020/04/20, add for widevine compatible
ifeq ($(TARGET_BUILD_VERSION),US)
ifneq ($(filter full_oppo6873 full_oppo6853, $(shell echo $(TARGET_PRODUCT) | sed -e 's/_1.*//g')),)
...
#Wenyang.Fan@PSW.MM.AudioDriver,2020/06/10, Add for change sia8109 boost voltage according to vol index
ifneq ($(filter oppo6853_20075, $(OPPO_TARGET_DEVICE)),)
    LOCAL_CFLAGS += -DOPPO_SIA_BOOST_VOL
