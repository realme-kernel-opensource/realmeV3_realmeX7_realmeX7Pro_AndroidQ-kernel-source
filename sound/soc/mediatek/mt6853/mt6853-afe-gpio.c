...
/* Hefeng.Wu@RM.MM.AudioDriver.Machine, 2020/06/13, add for speaker bringup */
	MT6853_AFE_GPIO_EXT_SPK_AMP_OFF,
	MT6853_AFE_GPIO_EXT_SPK_AMP_ON,
#endif /* VENDOR_EDIT */
...
#ifdef VENDOR_EDIT
/* Hefeng.Wu@RM.MM.AudioDriver.Machine, 2020/06/13, add for speaker bringup */
	[MT6853_AFE_GPIO_EXT_SPK_AMP_OFF] = {"ext_spk_amp_off", false, NULL},
	[MT6853_AFE_GPIO_EXT_SPK_AMP_ON] = {"ext_spk_amp_on", false, NULL},
#endif /* VENDOR_EDIT */
};
...
#ifdef VENDOR_EDIT
/* Hefeng.Wu@RM.MM.AudioDriver.Machine, 2020/06/13, add for speaker bringup */
    case EXT_SPK_AMP_ENABLE:
		if (enable) {
			mt6853_afe_gpio_select(afe, MT6853_AFE_GPIO_EXT_SPK_AMP_ON);
		} else {
			mt6853_afe_gpio_select(afe, MT6853_AFE_GPIO_EXT_SPK_AMP_OFF);
		}
		break;
#endif /* VENDOR_EDIT */
	default:
