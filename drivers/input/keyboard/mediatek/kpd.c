...
#include <../../../misc/mediatek/aee/aed/aed.h>
//mtk71029 add end.
...
void kpd_pwrkey_pmic_handler(unsigned long pressed)
{
	...
	//mtk71029 tick hang detect if is kpoc mode
	if (get_boot_mode() == KERNEL_POWER_OFF_CHARGING_BOOT && pressed) {
		aee_kernel_RT_Monitor_api(60);
	}
#endif
