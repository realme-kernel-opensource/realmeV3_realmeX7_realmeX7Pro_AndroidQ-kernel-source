...
#ifdef CONFIG_OPPO_CHARGER_MTK6889
/* Lukaili@BSP.CHG.Basic, 2020/06/06, Add for OTG */
extern bool oppo_otgctl_by_buckboost(void);
extern int oppo_otg_enable_by_buckboost(void);
extern int oppo_otg_disable_by_buckboost(void);
#endif
...
#ifdef CONFIG_OPPO_CHARGER_MTK6889
		if (oppo_otgctl_by_buckboost()) {
			oppo_otg_enable_by_buckboost();
		} else {
