...
#define AW8697_RTP_NAME_INDEX_REALME_START 500
...
int aw8697_is_rtp_index_valid(struct aw8697 *aw8697, unsigned int rtp_file_num)
{
...
char* aw8697_get_rtp_name(struct aw8697 *aw8697, unsigned int rtp_file_num)
{
