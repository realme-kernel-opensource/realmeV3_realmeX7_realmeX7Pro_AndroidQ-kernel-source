...
extern int is_pmic_mt6358_wakeup_reason;
#endif
...
//yangmingjin@realme.com, 2020/05/19, Add for power debug
	...
	power_helper_save_to_buf("[name:spm&][SPM] %s", log_buf);
#endif /* VENDOR_EDIT */
}
...
//yangmingjin@realme.com, 2020/05/19, Add for power debug
		...
		record_suspend_r13_info(mt6853_wake.r13, mt6853_wake.debug_flag, mt6853_wake.timer_out, plat_mmio_read(SPM_BK_VTCXO_DUR));
		#endif
...
//yangmingjin@realme.com, 2020/05/19, Add for power debug
#ifdef VENDOR_EDIT
int mt6853_wakeup_r13_table_size;
...
//yangmingjin@realme.com, 2020/05/19, Add for power debug
#ifdef VENDOR_EDIT
	power_helper_r13_sleep_data_init(mt6853_wakeup_r13_table, mt6853_wakeup_r13_table_size);
#endif /* VENDOR_EDIT */
