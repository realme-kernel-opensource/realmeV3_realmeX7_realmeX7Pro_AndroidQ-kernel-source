	...
	PK_INFO("%s secure state %d", __func__,
		...
		if (ret != ERROR_NONE) {
			...
			if (is_project(OPPO_19131)||is_project(OPPO_19132)||is_project(OPPO_19133)||is_project(OPPO_19420)
				...
				||is_project(OPPO_20601)||is_project(OPPO_20660)||is_project(OPPO_20630)||is_project(OPPO_20631)
				||is_project(OPPO_20632)||is_project(OPPO_20633)||is_project(OPPO_20634)||is_project(OPPO_20635)
				||is_project(OPPO_20625)||is_project(OPPO_20626)||is_project(OPPO_20605)||is_project(OPPO_206B4)){
...
int imgsensor_set_driver(struct IMGSENSOR_SENSOR *psensor)
{
	...
	|| is_project(OPPO_20680)) {
		...
		imgsensor_i2c_init(&psensor_inst->i2c_cfg,
			imgsensor_custom_config_20630[psensor_inst->sensor_idx].i2c_dev);
	} else if (is_project(OPPO_20625)|| is_project(OPPO_20626)) {
		imgsensor_i2c_init(&psensor_inst->i2c_cfg,
			imgsensor_custom_config_20625[psensor_inst->sensor_idx].i2c_dev);
	} else
	{
		imgsensor_i2c_init(&psensor_inst->i2c_cfg,
