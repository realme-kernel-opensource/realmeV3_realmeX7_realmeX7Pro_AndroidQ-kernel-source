...
enum IMGSENSOR_MODE {
	...
	IMGSENSOR_MODE_CUSTOM1,/* Shengguang.Zhu@Camera.Driver, 2020/04/01, add for remosaic */
...
struct imgsensor_info_struct {
	...
	struct imgsensor_mode_struct custom1; /* Shengguang.Zhu@Camera.Driver, 2020/04/01, add for remosaic */
