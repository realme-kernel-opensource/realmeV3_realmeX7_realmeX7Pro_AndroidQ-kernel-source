...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.cap = {/*data rate 420 Mbps/lane */       /* Shengguang.Zhu@Camera.Driver, 2020/03/22, add for capture binning size */
		.pclk = 140000000,
		.linelength = 2560,
		.framelength = 1822,
		.startx = 0,
	...
	.normal_video = {/*data rate 420 Mbps/lane */
		.pclk = 140000000,
		.linelength = 2560,
		.framelength = 1822,
		.startx = 0,
	...
	.hs_video = {/*data rate 1248 Mbps/lane */
#if 0
		.pclk = 416000000,
		.linelength = 2560,
		.framelength = 1354,
	...
	.slim_video = {/*data rate 420 Mbps/lane */
		.pclk = 140000000,
		.linelength = 2560,
		.framelength = 1822,
		.startx = 0,
	...
	/* Shengguang.Zhu@Camera.Driver, 2020/04/01, add for remosaic */
	.custom1 = {/*data rate 1680 Mbps/lane */
	    .pclk = 560000000,
		.linelength = 5120,
		.framelength = 3644,
		.startx = 0,
	...
	.custom1_delay_frame = 3,  /* Shengguang.Zhu@Camera.Driver, 2020/04/01, add for remosaic */
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
	...
	{4656, 3496, 0, 0, 4656, 3496, 2328, 1748,
	0000, 0000, 2328, 1748, 0, 0, 2328, 1748},	/*Capture*/
	{4656, 3496, 0, 0, 4656, 3496, 2328, 1748,
	0000, 0000, 2328, 1748, 0, 0, 2328, 1748},	/*Video*/
	//{4656, 3496, 0, 0, 4656, 3496, 2304, 1296,
	//0000, 0000, 2304, 1296, 0, 0, 2304, 1296},	/*hs-video*/
	{4656, 3496, 0, 0, 4656, 3496, 2328, 1748,
	0000, 0000, 2328, 1748, 0, 0, 2328, 1748},/*hs-video*/
	{4656, 3496, 0, 0, 4656, 3496, 2328, 1748,
	0000, 0000, 2328, 1748, 0, 0, 2328, 1748},	/*slim video*/
...
#endif
static kal_uint16 imx471_table_write_cmos_sensor(
...
kal_uint16 addr_data_pair_init_imx471[] = {
...
{
	pr_debug("02E\n");
	imx471_table_write_cmos_sensor(addr_data_pair_init_imx471,
	    sizeof(addr_data_pair_init_imx471)/sizeof(kal_uint16));
...
kal_uint16 addr_data_pair_preview_imx471[] = {
	/* MIPI output setting */
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	...
	0x020E, 0x01,
	0x020F, 0x00,
	/* Mode Transition Setting */
	0x3F15, 0x00,
};

static void preview_setting(void)
{
	imx471_table_write_cmos_sensor(
	addr_data_pair_preview_imx471,
	sizeof(addr_data_pair_preview_imx471) / sizeof(kal_uint16));
} /* preview_setting */


kal_uint16 addr_data_pair_capture_imx471[] = {
	/* MIPI output setting */
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
{
	imx471_table_write_cmos_sensor(addr_data_pair_capture_imx471,
		sizeof(addr_data_pair_capture_imx471) / sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_video_imx471[] = {
	/* MIPI output setting */
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
{
	pr_debug("E! %s:%d\n", __func__, currefps);
	imx471_table_write_cmos_sensor(addr_data_pair_video_imx471,
		sizeof(addr_data_pair_video_imx471) / sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_hs_video_imx471[] = {
	/* MIPI output setting */
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
{
	imx471_table_write_cmos_sensor(addr_data_pair_hs_video_imx471,
		sizeof(addr_data_pair_hs_video_imx471) / sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_slim_video_imx471[] = {
	/* MIPI output setting */
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
{
	imx471_table_write_cmos_sensor(addr_data_pair_slim_video_imx471,
	    sizeof(addr_data_pair_slim_video_imx471) / sizeof(kal_uint16));
}

/* Shengguang.Zhu@Camera.Driver, 2020/04/01, add for remosaic */
kal_uint16 addr_data_pair_custom1_imx471[] = {
	/* MIPI output setting */
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
{
	imx471_table_write_cmos_sensor(addr_data_pair_custom1_imx471,
		sizeof(addr_data_pair_custom1_imx471) / sizeof(kal_uint16));
} /* Shengguang.Zhu@Camera.Driver, 2020/04/01, add for remosaic */
...
static kal_uint32 imx471_awb_gain(struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
...
UINT32 IMX471_MIPI_RAW_SensorInit(
