...
static void read_eeprom_SN(void)
{
	...
	for (idx = 0; idx <40; idx++) {
		...
		if(idx < CAMERA_MODULE_SN_LENGTH)
...
static kal_int32 write_Module_data(ACDK_SENSOR_ENGMODE_STEREO_STRUCT * pStereodata)
{
	...
	if(pStereodata != NULL) {
		...
		if ((pStereodata->uSensorId == IMX586_SENSOR_ID)
				&& ((data_base == IMX586_STEREO_START_ADDR_WIDE)|| (data_base == IMX586_STEREO_START_ADDR_TELE))
			...
			write_eeprom_protect(1);
			msleep(6);
			if (data_base == IMX586_STEREO_START_ADDR_TELE) {
				pr_debug("com_0:0x%x\n", read_cmos_eeprom_8(IMX586_STEREO_START_ADDR_TELE));
				msleep(6);
				pr_debug("com_39:0x%x\n", read_cmos_eeprom_8(IMX586_STEREO_START_ADDR_TELE+39));
				msleep(6);
				pr_debug("innal_40:0x%x\n", read_cmos_eeprom_8(IMX586_STEREO_START_ADDR_TELE+40));
				msleep(6);
				pr_debug("innal_1556:0x%x\n", read_cmos_eeprom_8(IMX586_STEREO_START_ADDR_TELE+1556));
				msleep(6);
				pr_debug("tail1_1557:0x%x\n", read_cmos_eeprom_8(IMX586_STEREO_START_ADDR_TELE+1557));
				msleep(6);
				pr_debug("tail2_1558:0x%x\n", read_cmos_eeprom_8(IMX586_STEREO_START_ADDR_TELE+1558));
				msleep(6);
				pr_debug("tail3_1559:0x%x\n", read_cmos_eeprom_8(IMX586_STEREO_START_ADDR_TELE+1559));
				msleep(6);
				pr_debug("tail4_1560:0x%x\n", read_cmos_eeprom_8(IMX586_STEREO_START_ADDR_TELE+1660));
				msleep(6);
			} else {
				pr_debug("com_0:0x%x\n", read_cmos_eeprom_8(IMX586_STEREO_START_ADDR_WIDE));
				msleep(6);
				pr_debug("com_39:0x%x\n", read_cmos_eeprom_8(IMX586_STEREO_START_ADDR_WIDE+39));
				msleep(6);
				pr_debug("innal_40:0x%x\n", read_cmos_eeprom_8(IMX586_STEREO_START_ADDR_WIDE+40));
				msleep(6);
				pr_debug("innal_1556:0x%x\n", read_cmos_eeprom_8(IMX586_STEREO_START_ADDR_WIDE+1556));
				msleep(6);
				pr_debug("tail1_1557:0x%x\n", read_cmos_eeprom_8(IMX586_STEREO_START_ADDR_WIDE+1557));
				msleep(6);
				pr_debug("tail2_1558:0x%x\n", read_cmos_eeprom_8(IMX586_STEREO_START_ADDR_WIDE+1558));
				msleep(6);
				pr_debug("tail3_1559:0x%x\n", read_cmos_eeprom_8(IMX586_STEREO_START_ADDR_WIDE+1559));
				msleep(6);
				pr_debug("tail4_1560:0x%x\n", read_cmos_eeprom_8(IMX586_STEREO_START_ADDR_WIDE+1660));
				msleep(6);
			}
			...
			pr_debug("readback main aesync: %x %x %x %x %x %x %x %x\n"
				, read_cmos_eeprom_8(IMX586_AESYNC_START_ADDR)
				, read_cmos_eeprom_8(IMX586_AESYNC_START_ADDR+1)
				, read_cmos_eeprom_8(IMX586_AESYNC_START_ADDR+2)
				, read_cmos_eeprom_8(IMX586_AESYNC_START_ADDR+3)
				, read_cmos_eeprom_8(IMX586_AESYNC_START_ADDR+4)
				, read_cmos_eeprom_8(IMX586_AESYNC_START_ADDR+5)
				, read_cmos_eeprom_8(IMX586_AESYNC_START_ADDR+6)
				, read_cmos_eeprom_8(IMX586_AESYNC_START_ADDR+7));
		}else {
			...
			*sensor_id = ((read_cmos_sensor_8(0x0016) << 8)
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if(deviceInfo_register_value == 0x00){
					register_imgsensor_deviceinfo("Cam_r0", DEVICE_VERSION_IMX586, imgsensor_info.module_id);
