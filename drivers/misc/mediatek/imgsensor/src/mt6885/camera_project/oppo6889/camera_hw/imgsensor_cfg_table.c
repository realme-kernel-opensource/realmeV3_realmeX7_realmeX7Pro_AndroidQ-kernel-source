...
struct IMGSENSOR_HW_CFG imgsensor_custom_config_19040[] = {
	{
		...
		IMGSENSOR_I2C_DEV_0,
		{
			...
			{IMGSENSOR_HW_PIN_AVDD_AF, IMGSENSOR_HW_ID_REGULATOR},
			{IMGSENSOR_HW_PIN_DVDD,  IMGSENSOR_HW_ID_GPIO},
			{IMGSENSOR_HW_PIN_PDN,   IMGSENSOR_HW_ID_GPIO},
			{IMGSENSOR_HW_PIN_RST,   IMGSENSOR_HW_ID_GPIO},
			{IMGSENSOR_HW_PIN_NONE,  IMGSENSOR_HW_ID_NONE},
...
#ifdef VENDOR_EDIT
//Feiping.Li@Cam.Drv, 20200106, modify for 19040 camera drvier porting
#if defined(IMX586_MIPI_RAW)
		{
			SENSOR_DRVNAME_IMX586_MIPI_RAW,
			{
				...
				{AVDD_AF, Vol_2800, 1},
				{AVDD, Vol_2900, 0},
				{AVDD_1, Vol_1800, 0}, /* Feiping.Li@Cam.Drv, 20190912, driver porting */
				{DVDD, Vol_1100, 0},
				{DOVDD, Vol_1800, 1},
...
#if defined(IMX682_MIPI_RAW)
		{
			SENSOR_DRVNAME_IMX682_MIPI_RAW,
			{
				...
				{AVDD_AF, Vol_2800, 1},
				{AVDD, Vol_1800, 0},
				{AVDD_1, Vol_2900, 0}, /* wenhui.chen@Cam.Drv, 20200316, driver porting */
				{DVDD, Vol_1100, 0},
				{DOVDD, Vol_1800, 1},
				{SensorMCLK, Vol_High, 1},
				{RST, Vol_High, 2},
...
/* Feiping.Li@Cam.Drv, 20190912, driver porting */
	...
	{
		SENSOR_DRVNAME_OV32A1Q_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{AVDD, Vol_2800, 0},
			{DVDD, Vol_1100, 0},
...
#endif
#ifndef VENDOR_EDIT
//Feiping.Li@Cam.Drv, 20190929, remove for use custom define part
#if defined(IMX686_MIPI_RAW)
	{
		SENSOR_DRVNAME_IMX686_MIPI_RAW,
		{
