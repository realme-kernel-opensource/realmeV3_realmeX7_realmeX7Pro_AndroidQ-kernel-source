...
#ifdef VENDOR_EDIT
/* Wenjun.Wu@Cam.Drv, 20200413, add for 20001 AF*/
...
extern long BU64253GWZAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int BU64253GWZAF_Release(struct inode *a_pstInode, struct file *a_pstFile);
...
#define BU63169AF_OisGetHallPos BU63169AF_OisGetHallPos_Main
#define BU63169AF_OisGetHallInfo BU63169AF_OisGetHallInfo_Main
...
#ifdef VENDOR_EDIT
//Feiping.Li@Cam.drv, 20200107, add for 19040 ois
extern int  BU63169AF_OisGetHallPos(int *PosX, int *PosY);
extern int  BU63169AF_OisGetHallInfo(void *a_pOisPosInfo);
#endif
#endif
