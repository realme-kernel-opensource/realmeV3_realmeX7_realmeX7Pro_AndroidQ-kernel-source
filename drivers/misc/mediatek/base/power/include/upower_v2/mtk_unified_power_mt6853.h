 ...
 */
  ...
  **********************************************/
#ifndef MTK_UNIFIED_POWER_MT6853_H
#define MTK_UNIFIED_POWER_MT6853_H
...
#define NR_UPOWER_TBL_LIST 7 /* num of all tables */
/* upower banks */
enum upower_bank {
	UPOWER_BANK_LL,
	UPOWER_BANK_L,
...
#define UPOWER_DT_NODE "mediatek,mt6853-upower"
struct upower_doe {
