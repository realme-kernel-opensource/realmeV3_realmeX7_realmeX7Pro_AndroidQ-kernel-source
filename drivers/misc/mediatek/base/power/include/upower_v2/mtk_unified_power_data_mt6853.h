...
struct upower_tbl upower_tbl_l_B26G = {
	.row = {
		{.cap = 143, .volt = 65000, .dyn_pwr = 15882,
			.lkg_pwr = {24121, 24121, 24121, 24121, 24121, 24121} },
		{.cap = 177, .volt = 65000, .dyn_pwr = 20646,
			.lkg_pwr = {24121, 24121, 24121, 24121, 24121, 24121} },
		{.cap = 187, .volt = 66250, .dyn_pwr = 23197,
			.lkg_pwr = {24952, 24952, 24952, 24952, 24952, 24952} },
		{.cap = 197, .volt = 67500, .dyn_pwr = 25896,
			.lkg_pwr = {25784, 25784, 25784, 25784, 25784, 25784} },
		{.cap = 215, .volt = 70000, .dyn_pwr = 31755,
			.lkg_pwr = {27447, 27447, 27447, 27447, 27447, 27447} },
		{.cap = 233, .volt = 72500, .dyn_pwr = 38252,
			.lkg_pwr = {29107, 29107, 29107, 29107, 29107, 29107} },
		{.cap = 242, .volt = 74375, .dyn_pwr = 43583,
			.lkg_pwr = {30353, 30353, 30353, 30353, 30353, 30353} },
		{.cap = 256, .volt = 76250, .dyn_pwr = 48809,
			.lkg_pwr = {31710, 31710, 31710, 31710, 31710, 31710} },
		{.cap = 277, .volt = 80000, .dyn_pwr = 60064,
			.lkg_pwr = {34537, 34537, 34537, 34537, 34537, 34537} },
		{.cap = 294, .volt = 82500, .dyn_pwr = 68188,
			.lkg_pwr = {36675, 36675, 36675, 36675, 36675, 36675} },
		{.cap = 301, .volt = 85000, .dyn_pwr = 76847,
			.lkg_pwr = {38812, 38812, 38812, 38812, 38812, 38812} },
		{.cap = 315, .volt = 89375, .dyn_pwr = 90570,
			.lkg_pwr = {42932, 42932, 42932, 42932, 42932, 42932} },
		{.cap = 326, .volt = 92500, .dyn_pwr = 101058,
			.lkg_pwr = {46122, 46122, 46122, 46122, 46122, 46122} },
		{.cap = 331, .volt = 94375, .dyn_pwr = 107555,
			.lkg_pwr = {48073, 48073, 48073, 48073, 48073, 48073} },
		{.cap = 341, .volt = 97500, .dyn_pwr = 118796,
			.lkg_pwr = {51703, 51703, 51703, 51703, 51703, 51703} },
		{.cap = 346, .volt = 100000, .dyn_pwr = 128148,
			.lkg_pwr = {54682, 54682, 54682, 54682, 54682, 54682} },
	},
	.lkg_idx = DEFAULT_LKG_IDX,
	.row_num = UPOWER_OPP_NUM,
...
struct upower_tbl upower_tbl_cluster_l_B26G = {
	.row = {
		{.cap = 143, .volt = 65000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 177, .volt = 65000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 187, .volt = 66250, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 197, .volt = 67500, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 215, .volt = 70000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 233, .volt = 72500, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 242, .volt = 74375, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 256, .volt = 76250, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 277, .volt = 80000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 294, .volt = 82500, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 301, .volt = 85000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 315, .volt = 89375, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 326, .volt = 92500, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 331, .volt = 94375, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 341, .volt = 97500, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 346, .volt = 100000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
	},
	.lkg_idx = DEFAULT_LKG_IDX,
	.row_num = UPOWER_OPP_NUM,
...
struct upower_tbl upower_tbl_b_B26G = {
	.row = {
		{.cap = 595, .volt = 65000, .dyn_pwr = 88354,
			.lkg_pwr = {95432, 95432, 95432, 95432, 95432,
			95432} },
		{.cap = 649, .volt = 67500, .dyn_pwr = 110395,
			.lkg_pwr = {101909, 101909, 101909, 101909, 101909,
			101909} },
		{.cap = 678, .volt = 68750, .dyn_pwr = 122429,
			.lkg_pwr = {105148, 105148, 105148, 105148, 105148,
			105148} },
		{.cap = 712, .volt = 70625, .dyn_pwr = 141715,
			.lkg_pwr = {110005, 110005, 110005, 110005, 110005,
			110005} },
		{.cap = 733, .volt = 71875, .dyn_pwr = 155269,
			.lkg_pwr = {113241, 113241, 113241, 113241, 113241,
			113241} },
		{.cap = 733, .volt = 73750, .dyn_pwr = 176368,
			.lkg_pwr = {118096, 118096, 118096, 118096, 118096,
			118096} },
		{.cap = 776, .volt = 76875, .dyn_pwr = 214580,
			.lkg_pwr = {126803, 126803, 126803, 126803, 126803,
			126803} },
		{.cap = 814, .volt = 80000, .dyn_pwr = 256656,
			.lkg_pwr = {135922, 135922, 135922, 135922, 135922,
			135922} },
		{.cap = 841, .volt = 82500, .dyn_pwr = 293432,
			.lkg_pwr = {143381, 143381, 143381, 143381, 143381,
			143381} },
		{.cap = 869, .volt = 85000, .dyn_pwr = 332437,
			.lkg_pwr = {150841, 150841, 150841, 150841, 150841,
			150841} },
		{.cap = 893, .volt = 86875, .dyn_pwr = 367363,
			.lkg_pwr = {157538, 157538, 157538, 157538, 157538,
			157538} },
		{.cap = 912, .volt = 88750, .dyn_pwr = 403875,
			.lkg_pwr = {164235, 164235, 164235, 164235, 164235,
			164235} },
		{.cap = 945, .volt = 91875, .dyn_pwr = 467747,
			.lkg_pwr = {175600, 175600, 175600, 175600, 175600,
			175600} },
		{.cap = 968, .volt = 93750, .dyn_pwr = 509336,
			.lkg_pwr = {182500, 182500, 182500, 182500, 182500,
			182500} },
		{.cap = 991, .volt = 96250, .dyn_pwr = 573787,
			.lkg_pwr = {192560, 192560, 192560, 192560, 192560,
			192560} },
		{.cap = 1024, .volt = 100000, .dyn_pwr = 681778,
			.lkg_pwr = {208942, 208942, 208942, 208942, 208942,
			208942} },
	},
	.lkg_idx = DEFAULT_LKG_IDX,
...
struct upower_tbl upower_tbl_cluster_b_B26G = {
	.row = {
		{.cap = 595, .volt = 65000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 649, .volt = 67500, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 678, .volt = 68750, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 712, .volt = 70625, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 733, .volt = 71875, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 733, .volt = 73750, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 776, .volt = 76875, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 814, .volt = 80000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 841, .volt = 82500, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 869, .volt = 85000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 893, .volt = 86875, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 912, .volt = 88750, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 945, .volt = 91875, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 968, .volt = 93750, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 991, .volt = 96250, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 1024, .volt = 100000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
	},
...
struct upower_tbl upower_tbl_cci_B26G = {
	.row = {
		{.cap = 0, .volt = 65000, .dyn_pwr = 9264,
			.lkg_pwr = {30145, 30145, 30145, 30145, 30145, 30145} },
		{.cap = 0, .volt = 66250, .dyn_pwr = 10415,
