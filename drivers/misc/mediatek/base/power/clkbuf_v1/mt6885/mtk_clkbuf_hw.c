...
//yangmingjin@realme.com, 2020/05/19, Add for power debug
#ifdef VENDOR_EDIT
		power_helper_save_to_buf("%s", "suspend warning: XO_WCN is on!!");
#endif /* VENDOR_EDIT */
	}
...
//yangmingjin@realme.com, 2020/05/19, Add for power debug
#ifdef VENDOR_EDIT
		power_helper_save_to_buf("%s", "suspend warning: XO_NFC is on!!");
#endif /* VENDOR_EDIT */
	}
...
//yangmingjin@realme.com, 2020/05/19, Add for power debug
#ifdef VENDOR_EDIT
		power_helper_save_to_buf("%s", "suspend warning: XO_CEL is on!!");
#endif /* VENDOR_EDIT */
	}
	if (xo_en_stat[XO_PD]){
...
//yangmingjin@realme.com, 2020/05/19, Add for power debug
#ifdef VENDOR_EDIT
		power_helper_save_to_buf("%s", "suspend warning: XO_PD is on!!");
#endif /* VENDOR_EDIT */
	}
...
//yangmingjin@realme.com, 2020/05/19, Add for power debug
#ifdef VENDOR_EDIT
		power_helper_save_to_buf("%s", "suspend warning: XO_EXT is on!!");
#endif /* VENDOR_EDIT */
	}
	return 0;
}
