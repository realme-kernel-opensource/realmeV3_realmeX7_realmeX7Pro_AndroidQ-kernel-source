...
extern void bq2591x_dump_registers(void);
extern int bq2591x_hardware_init(void);
extern int bq2591x_charging_current_write_fast(int current_ma);
extern int bq2591x_input_current_limit_write(int curr);
extern int bq2591x_float_voltage_write(int volt);
extern int bq2591x_enable_charging(void);
extern int bq2591x_disable_charging(void);
