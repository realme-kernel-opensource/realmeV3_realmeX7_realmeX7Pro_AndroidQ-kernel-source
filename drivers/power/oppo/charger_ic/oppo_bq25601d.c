...
#include <mt-plat/mtk_rtc.h>
#elif defined(CONFIG_OPPO_DUAL_CHARGER_SUPPORT)
#include <linux/module.h>
#else
...
{
#ifdef CONFIG_OPPO_CHARGER_MTK
#if defined(CONFIG_OPPO_CHARGER_MTK6763) || defined(CONFIG_OPPO_CHARGER_MTK6771) || defined(CONFIG_OPPO_DUAL_CHARGER_SUPPORT)
	int ret = 0;
...
#if defined (CONFIG_MTK_PMIC_CHIP_MT6353) || defined(CONFIG_OPPO_CHARGER_MTK6763) || defined(CONFIG_OPPO_CHARGER_MTK6771) || defined(CONFIG_OPPO_DUAL_CHARGER_SUPPORT)
