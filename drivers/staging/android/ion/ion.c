 ...
 * travel all ion bufers with sort.
 */
...
/* Kui.Zhang@BSP.Kernel.MM, 2020-05-20 add ion memleak detect dameon, only
 * in offline aging test.
 */
#define ION_DEBUG_LOG_TAG "ion_debug"
#define BUFLEN(total, len) (total - len - 1)
#define ION_DEBUG_MIN_WATERMARK 180lu
#define ION_DEBUG_MAX_WATERMARK 550lu
...
void dump_ion_info(char *dump_buff, int len)
{
	pr_warn("[ion_debug] May be not config CONFIG_MEMLEAK_DETECT_THREAD or CONFIG_OPPO_SVELTE.\n");
}
#endif
