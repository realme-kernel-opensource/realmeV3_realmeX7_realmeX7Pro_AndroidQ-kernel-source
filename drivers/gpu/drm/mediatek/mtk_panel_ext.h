...
/**
	...
	#endif
	#ifdef VENDOR_EDIT
	/* shangruofan@PSW.MM.DisplayDriver.DC, 2020/7/28, add for DC enter */
	int (*lcm_dc_enterd)(void *dsi_drv, dcs_write_gce cb,
		void *handle);
	int (*lcm_dc_exitd)(void *dsi_drv, dcs_write_gce cb,
		void *handle);
