...
int mtk_mipi_tx_dphy_lane_config(struct phy *phy, struct mtk_panel_ext *mtk_panel);
int mtk_mipi_tx_cphy_lane_config(struct phy *phy, struct mtk_panel_ext *mtk_panel);
