...
#define DISP_SLOT_CUR_USER_CMD_IDX (DISP_SLOT_OVL_STATUS + 0x4)
#else
...
#ifdef VENDOR_EDIT
/** LiPing-M@PSW.MM.Display.LCD.Machine, 2019/11/19,add for ffl **/
	struct task_struct *ffl_set_task;
	wait_queue_head_t ffl_task_wq;
#endif
};
