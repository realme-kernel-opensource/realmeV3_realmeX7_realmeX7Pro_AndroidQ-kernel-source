...
static void jdi_panel_init(struct jdi *ctx)
{
	...
	jdi_dcs_write_seq_static(ctx, 0xB0, 0x01);
...
static struct drm_display_mode default_mode = {
	.clock = 372734,
	.hdisplay = HAC,
	.hsync_start = HAC + 149,//HFP
	.hsync_end = HAC + 149 + 22,//HSA
	.htotal = HAC + 149 + 22 + 22,//HBP1289
	.vdisplay = 2400,
	.vsync_start = VAC + 2460,//VFP
	.vsync_end = VAC + 2460 + 10,//VSA
	.vtotal = VAC + 2460 + 10 + 10,//VBP4948
	.vrefresh = 60,
};
...
static struct drm_display_mode performance_mode = {
	...
	.hsync_start = HAC + 149,//HFP
	.hsync_end = HAC + 149 + 22,//HSA
	.htotal = HAC + 149 + 22 + 22,//HBP
	.vdisplay = VAC,
	.vsync_start = VAC + 860,//VFP
	.vsync_end = VAC + 860 + 10,//VSA
	.vtotal = VAC + 860 + 10 + 10,//VBP3299
	.vrefresh = 90,
};
