...
static int lcm_panel_regulator_enable(struct lcm *ctx)
{
    ...
    if (is_fan53870_pmic()) {
        ...
        ret = lcm_panel_pm8008_ldo1_enable(ctx->dev);
    }
    msleep(2);
...
static int lcm_panel_regulator_disable(struct lcm *ctx)
{
    ...
    if (is_fan53870_pmic()) {
        ...
        ret = lcm_panel_pm8008_ldo1_disable(ctx->dev);
    }
    msleep(5);
...
static const struct drm_display_mode default_mode = {
	...
	.hsync_end = 1080 + 128 + 32,
	.htotal = 1080 + 128 + 32 + 128,
	.vdisplay = 2400,
	.vsync_start = 2400 + 8,
	.vsync_end = 2400 + 8 + 2,
	.vtotal = 2400 + 8 + 2 + 8,
	...
	enum MTK_PANEL_MODE_SWITCH_STAGE stage)
{
	...
	if (stage == BEFORE_DSI_POWERDOWN) {
		...
		lcm_dcs_write_seq_static(ctx, 0x6F, 0x03);
        lcm_dcs_write_seq_static(ctx, 0xC0, 0x80, 0x00, 0x00);
		lcm_dcs_write_seq_static(ctx, 0x26, 0x01); /* 60 FPS */
	}
}
...
static struct LCM_setting_table lcm_normal_power_on_seq[] = {
	...
	{REGFLAG_CMD, 2, {0xF3,0xCB}},

	{REGFLAG_CMD, 2, {0x6F,0x05}},    /* OSC=101.6Mhz */
	{REGFLAG_CMD, 3, {0xFD,0x00,0xD8}},

	{REGFLAG_CMD, 2, {0xFB,0x20}},    /* DVDD strong=1.08V */
	{REGFLAG_CMD, 2, {0x6F,0x06}},
	{REGFLAG_CMD, 2, {0xFB,0x04}},
    ...
    {REGFLAG_CMD, 9, {0xBA,0x01,0xD4,0x00,0x08,0x00,0x08,0x80,0x01}},
    {REGFLAG_CMD, 2, {0x6F,0x08}},
    {REGFLAG_CMD, 9, {0xBA,0x01,0xD4,0x00,0x08,0x00,0x08,0x00,0x10}},
    {REGFLAG_CMD, 2, {0x6F,0x10}},
    {REGFLAG_CMD, 15, {0xBA,0x01,0xD4,0x00,0x08,0x00,0x08,0x02,0x30,0x00,0x08,0x00,0x08,0x00,0x00}},
    {REGFLAG_CMD, 9, {0xBB,0x01,0xD4,0x00,0x08,0x00,0x08,0x00,0x31}},
    {REGFLAG_CMD, 6, {0xC0,0x76,0x33,0x00,0x00,0x00}},
    {REGFLAG_CMD, 3, {0xC1,0x00,0x70}},

    {REGFLAG_CMD, 6, {0xF0,0x55,0xAA,0x52,0x08,0x03}},
    {REGFLAG_CMD, 11, {0xB2,0x00,0x00,0x0A,0x06,0x01,0x00,0x00,0x0A,0x06,0x01}},
    {REGFLAG_CMD, 11, {0xB3,0x00,0x00,0x00,0x04,0x26,0x00,0x00,0x00,0x04,0x26}},
    {REGFLAG_CMD, 22, {0xB6,0x03,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x08,0x00,0x00,0x00,0x00,0x00,0x08,0x00,0x00,0x00,0x00,0x00,0x00}},
    {REGFLAG_CMD, 8, {0xBB,0x11,0x00,0x23,0x63,0x00,0x23,0x63}},
    {REGFLAG_CMD, 8, {0xBC,0x22,0x10,0x19,0x5A,0x00,0x19,0x5A}},
    {REGFLAG_CMD, 8, {0xBC,0x22,0x10,0x1E,0x6C,0x00,0x1E,0x6C}},

    {REGFLAG_CMD, 6, {0xF0,0x55,0xAA,0x52,0x08,0x01}},
    {REGFLAG_CMD, 3, {0xB2,0x02,0x02}},
    {REGFLAG_CMD, 3, {0xB3,0x14,0x14}},
    {REGFLAG_CMD, 7, {0xB7,0x1A,0x1A,0x1A,0x1A,0x1A,0x1A}},
    {REGFLAG_CMD, 8, {0xD2,0x00,0x41,0x10,0x41,0x25,0x00,0x67}},
    {REGFLAG_CMD, 2, {0xCE,0x04}},
    {REGFLAG_CMD, 2, {0xC7,0xFA}},
    {REGFLAG_CMD, 5, {0xFF,0xAA,0x55,0xA5,0x80}},
    {REGFLAG_CMD, 2, {0x6F,0x0A}},
    {REGFLAG_CMD, 2, {0xFC,0x02}},
    {REGFLAG_CMD, 5, {0xFF,0xAA,0x55,0xA5,0x00}},

    {REGFLAG_CMD, 5, {0xFF,0xAA,0x55,0xA5,0x81}},
    {REGFLAG_CMD, 2, {0x6F,0x09}},
    {REGFLAG_CMD, 2, {0xFD,0xAC}},
    {REGFLAG_CMD, 6, {0xF0,0x55,0xAA,0x52,0x08,0x01}},
    //{0xC3, 7, {0x99,0x00,0xFc,0x0F,0xE1,0x81,0x00}},
    {REGFLAG_CMD, 8, {0xC3,0x19,0x00,0xFC,0x0F,0x22,0x01,0x00}},

    {REGFLAG_CMD, 1, {0x35}},
    {REGFLAG_CMD, 5, {0x3B,0x00,0x08,0x00,0x08}},
    {REGFLAG_CMD, 2, {0x53,0x20}},
    {REGFLAG_CMD, 5, {0x51,0x06,0xF4,0x0F,0xFF}},
    {REGFLAG_CMD, 5, {0x2A,0x00,0x00,0x04,0x37}},
    {REGFLAG_CMD, 5, {0x2B,0x00,0x00,0x09,0x5F}},
    {REGFLAG_CMD, 2, {0x26,0x01}},
//##VESA 8bit3x slice 20 for BOE
    {REGFLAG_CMD, 19, {0x91,0x89,0x28,0x00,0x14,0x02,0x00,0x02,0x0E,0x01,0xE8,0x00,0x07,0x05,0x0E,0x05,0x16,0x10,0xF0}},
//##PPS Table1
...
static const struct of_device_id lcm_of_match[] = {
	{ .compatible = "oppo20601_boe_nt37800_1080p_dsi_cmd", },
	{ }
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "oppo20601_boe_nt37800_1080p_dsi_cmd",
		.owner = THIS_MODULE,
