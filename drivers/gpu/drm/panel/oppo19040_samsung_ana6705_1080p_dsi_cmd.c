...
int lcm_regulator_be_enabled = 0;
EXPORT_SYMBOL(lcm_regulator_be_enabled);
...
#ifdef CONFIG_MACH_MT6885
/* Shipei.Chen@Cam.Drv, 20200727, modify for dali enable Fan53870*/
int is_check_lcm_status_ana6705(void)
{
    printk("For checking lcm_status: %d \n", lcm_status);
    return lcm_status;
}
EXPORT_SYMBOL(is_check_lcm_status_ana6705);
#endif
...
#ifdef VENDOR_EDIT
	/* Hujie@PSW.MM.DisplayDriver.AOD, 2019/12/10, add for keylog*/
	pr_err("debug for samsung lcm %s\n", __func__);
#endif
			      ...
			      dcs_write_gce cb, void *handle, bool en)
{
	...
	pr_err("samsung lcm: debug for oppo_display_brightness= %ld, en=%u\n", oppo_display_brightness, en);
...
static const struct of_device_id lcm_of_match[] = {
	{ .compatible = "oppo19040_samsung_ana6705_1080p_dsi_cmd", },
	{ }
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "oppo19040_samsung_ana6705_1080p_dsi_cmd",
		.owner = THIS_MODULE,
